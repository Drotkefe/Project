...
func TestXxx(t *testing.T) {
	kaja := []models.MemberBalance{
		{Member: models.Member{ID: 1, Name: "Patrik"}, Balance: -2000, TripID: 1},
		{Member: models.Member{ID: 2, Name: "Balint"}, Balance: -2000, TripID: 1},
		{Member: models.Member{ID: 3, Name: "Balazs"}, Balance: -2000, TripID: 1},
		{Member: models.Member{ID: 4, Name: "Peti"}, Balance: 8000, TripID: 1},
	}
	pia := []models.MemberBalance{
		{Member: models.Member{ID: 1, Name: "Patrik"}, Balance: 15000, TripID: 1},
		{Member: models.Member{ID: 2, Name: "Balint"}, Balance: -3750, TripID: 1},
		{Member: models.Member{ID: 3, Name: "Balazs"}, Balance: -3750, TripID: 1},
		{Member: models.Member{ID: 4, Name: "Peti"}, Balance: -3750, TripID: 1},
	}
	sajtburi := []models.MemberBalance{
		{Member: models.Member{ID: 1, Name: "Patrik"}, Balance: -1200, TripID: 1},
		{Member: models.Member{ID: 2, Name: "Balint"}, Balance: 3600, TripID: 1},
		{Member: models.Member{ID: 3, Name: "Balazs"}, Balance: -1200, TripID: 1},
	}

	complements := ComputeSettlements([][]models.MemberBalance{kaja, pia, sajtburi})
	for _, c := range complements {
		t.Logf("%s pays %s: %.2f", c.FromName, c.ToName, c.Amount)
	}
}
